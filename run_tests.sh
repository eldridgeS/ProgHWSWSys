...
test_output_0="Earliest year in which both lived in the same city: 0"
test_output_1990="Earliest year in which both lived in the same city: 1990"
test_output_2004="Earliest year in which both lived in the same city: 2004"
test_output_2008="Earliest year in which both lived in the same city: 2008"
